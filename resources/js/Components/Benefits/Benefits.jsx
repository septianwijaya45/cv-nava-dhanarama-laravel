          ...
          <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0">
              <div className="flex flex-col justify-center ">
                  ...
                  <p className="text-lg text-gray-600">
                      uses new technology to keep up with popular technology
                      trends and protects your data with data encryption.
                  </p>
                  ...
                  <div className="grid grid-cols-2 py-16">
                      <div className="py-6 flex">
                          ...
                          <div className="px-3">
                              ...
                              <p className="text-[#6D737A] text-sm">
                                  understand structurally and in order to build
                                  the required application requirements
                              </p>
                          </div>
                      </div>
                      <div className="py-6 flex">
                          ...
                          <div className="px-3">
                              ...
                              <p className="text-[#6D737A] text-sm">
                                  assist in customer application maintenance to
                                  fix bugs or add functional or non-functional
                      ...
                      <div className="py-6 flex">
                          ...
                          <div className="px-3">
                              ...
                              <p className="text-[#6D737A] text-sm">
                                  Collaboration between Nava Dhanarama Indonesia
                                  and customers to support and develop
                                  applications.
                              </p>
                          </div>
                      </div>
