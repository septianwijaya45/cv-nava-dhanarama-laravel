...
export default function Contact({ flash }) {
    ...
    return (
        <FrontendLayout
            title="Contact - NAVA DHANARAMA INDONESIA"
            metaDescription="Kontak Nava Dhanarama untuk mendiskusikan proyek Anda dan bagaimana kami dapat membantu mewujudkan visi Anda."
            >
            {/* Header */}
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-gray-600">cvnavadhanaramaindonesia@gmail.com</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-gray-600">+62 859-6289-0502</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-gray-600">Nganjuk, Indonesia</p>
                                    </div>
                                </div>
                            ...
                            <div className="mt-8">
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    <a href="https://www.instagram.com/navadhanaramaindonesia/" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-brand-600 hover:text-white transition duration-200">
